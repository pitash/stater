                            ...
                            @forelse ($menu->menuItems as $item)
                                <li class="dd-item" data-id="{{ $item->id }}">
                                    <div class="pull-right item_actions">
                                        <button value="{{ route('app.menus.item.edit', ['id' => $menu->id, 'itemId'=>$item->id]) }}" type="button" href="" 
                                        ...
                                        <ol class="dd-list">
                                            @foreach ($item->childs as $childItem)
                                                <li class="dd-item" data-id="{{ $childItem->id }}">
                                                    <div class="pull-right item_actions">
                                                        <button value="{{ route('app.menus.item.edit', ['id' => $menu->id, 'itemId'=>$childItem->id]) }}" type="button" href="" 
                                                            class="btn btn-info btn-sm edit_link" title='Edit'>
                                                            <i class="fas fa-edit"></i>
                                                            <span>Edit</span>
                                                        </button>
