...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <!-- form start -->
            <form id="settingsFrom" autocomplete="off" role="form" method="POST" action="{{ route('app.settings.general.update') }}">
                @csrf
                @method('PATCH')
                    ...
                    <div class="card-body">
                       <div class="form-group">
                         ...
                         <div class="form-group">
                             ...
                             <textarea type="text" name="site_description" id="site_description" class="form-control @error('site_description') 
                             is-invalid @enderror">{!! setting('site_description') ?? old('site_description') !!}</textarea>
